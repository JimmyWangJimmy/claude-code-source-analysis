...
> **导读｜读完这章能做什么**
> - 了解 Claude Code 选型逻辑，评估是否适合自己的 Agent 项目
> - 掌握 Bun + React/Ink + Zod 的组合方式

## 这份源码能带来什么价值?

### 1. 理解 AI Agent 的工程架构

Claude Code 是目前主流的 AI 编码 Agent 之一。源码完整揭示了:
...
源码中包含了 Anthropic 调优过的 system prompt，展示了:

- 如何通过 prompt 塑造 Agent 行为
- 如何动态组装上下文 (git 状态、用户记忆、工具列表)
- 如何在安全性与实用性之间做 prompt 层面的取舍
