...
**启示 1：如果打算做多 Agent，从第一天就把它当作架构决策，而不是后加功能。**
...
<img src="../assets/agent-lifecycle.svg" alt="AbortController链" width="100%">
